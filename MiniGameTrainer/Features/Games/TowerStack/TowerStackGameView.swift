...
struct TowerStackGameView: View {
    ...
    var body: some View {
        TowerStackGameContentView(
            viewModel: TowerStackGameViewModel(
...
private struct TowerStackGameContentView: View {
    @StateObject private var viewModel: TowerStackGameViewModel
    @EnvironmentObject private var router: AppRouter
    @EnvironmentObject private var statistics: StatisticsStore
    @Environment(\.scenePhase) private var scenePhase

    init(viewModel: @autoclosure @escaping () -> TowerStackGameViewModel) {
        ...
        GeometryReader { proxy in
            ...
            ZStack {
                if let scene = viewModel.scene(for: fullSize) {
                    ...
                    .ignoresSafeArea()
                    .accessibilityLabel("Tower Stack game area. Tap to place the moving block.")
                } else {
...
private struct TowerStackPauseOverlay: View {
    let onResume: () -> Void
    let onRestart: () -> Void
    let onQuit: () -> Void
