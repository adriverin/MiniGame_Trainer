...
**TIME'S UP!**, **GRID**, **TRACE**, **Directions**, **TAP AT 7**, **SWIPE FAST**, **TARGET SPEED**,
**BLOOPY**, and **COLOR REFLEX**.
...
`Documentation/TARGET_SPEED_GAME_ANALYSIS.md`,
`Documentation/BLOOPY_GAME_ANALYSIS.md`, and
...
`MiniGameTrainerTests` covers all fifteen games plus shared statistics: scoring, invalid input,
